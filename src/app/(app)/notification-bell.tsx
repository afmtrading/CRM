 ...
 *
 * It is the same markup minus the badge, so the header does not reflow when
 ...
 * anything rendered, which put a full round trip in front of the entire app
 * shell on every navigation. requireSession is request-cached, so asking for
