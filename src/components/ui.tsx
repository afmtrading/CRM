 ...
 *
 * Every screen is server-rendered on demand against Supabase, so a navigation
 * used to leave the previous one in place until the last query came back.
 * These give the Suspense boundaries something to show, so the shell paints
 * straight away and the content fills in behind it.
 */
...
/** Placeholder for a list card, sized to the real table's rhythm. */
